<?php include("header.php");
 $con = mysqli_connect("localhost","root","","orphanage");
    $qry = "select * from `orp_register` where `status`='2'";
    // echo $qry; die;
                   ...
                   <table border="1" style="margin: 8px 0px 0px 8px;" cellpadding="2px">
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display: flex;justify-content: space-around;"><a href="reject_orp.php?id=<?php echo $row['orp_id']; ?>&rj=1"><i class="fa-regular fa-thumbs-up"></i></a></div>
                                        </td>
                                    </tr>
                    <?php
                                }
